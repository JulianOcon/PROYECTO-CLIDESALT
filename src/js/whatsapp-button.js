...
target="_blank"
id="whatsappButton"
class="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-4 py-3 rounded-full shadow-2xl transition-all duration-300 hover:scale-105"
>

<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-white flex-shrink-0" viewBox="0 0 24 24">
...
<span id="waText" class="hidden text-sm font-semibold whitespace-nowrap">
¿Necesitas servicio?
</span>
